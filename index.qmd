...
<div id="gw">
  ...
  <div id="lb-section">
    ...
    <ul id="lb-list"><li style="font-size:13px;color:#d4537e;padding:6px">Loading leaderboard...</li></ul>
  </div>
</div>

<script>
const BIN_ID='69d4e8e3aaba882197d1bc8f';
const API_KEY='$2a$10$dgmp9aT06xyTnrJhC0GocOqkwzDJYTyTkvcxUUSEei3i56qzq.uWm';
...
function drawPrincess(x,y,w,h,dead,lf){
  ...
  }else{ctx.fillRect(x-5,y+h*.36,6,11);ctx.fillRect(x+w-1,y+h*.28,6,11);}
...
function endGame(){
  ...
  if(score>best){
    best=score;localStorage.setItem('princessBest2',best);
    document.getElementById('best-disp').textContent=best;
    document.getElementById('msg').textContent='New High Score! 🎉 '+score;
  }else{
...
async function loadLeaderboard(){
  ...
  try{
    ...
    ul.innerHTML='<li style="font-size:13px;color:#d4537e;padding:6px">Could not load leaderboard</li>';
  }
}
...
async function saveScore(){
  ...
  try{
    ...
    await pushScores(entries);
    await loadLeaderboard();
    document.getElementById('msg').textContent='Saved! Good luck next time 👑';
  }catch(e){
    document.getElementById('msg').textContent='Could not save. Try again!';
  }
}
